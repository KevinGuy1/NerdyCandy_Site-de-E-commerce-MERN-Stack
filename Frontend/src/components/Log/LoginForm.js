...
const SignInForm = () => {
  ...
  return (
    <form className="w-3/5 py-4 px-5" action="" onSubmit={handleLogin}>
      ...
      <br />
      <input
        className="bg-secondary rounded-2xl px-3 py-1 hover:bg-tertiary hover:text-primary hover:shadow-primary hover:shadow-sm"
        type="submit"
        value="Se connecter" />
    </form>
  );
